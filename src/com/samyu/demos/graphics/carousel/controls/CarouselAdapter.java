...
package com.samyu.demos.graphics.carousel.controls;
...
public abstract class CarouselAdapter<T extends Adapter> extends ViewGroup {
    ...
    /**
     * The offset in pixels from the top of the CarouselAdapter to the top of
     * the view to select during the next layout.
     */
    int mSpecificTop;
    ...
    public interface OnItemClickListener {
        ...
        /**
         * Callback method to be invoked when an item in this CarouselAdapter
         * has been clicked.
         * <p>
    ...
    /**
     * Register a callback to be invoked when an item in this CarouselAdapter
     * has been clicked.
     * 
    ...
    /**
     * @return The callback to be invoked with an item in this CarouselAdapter
    ...
    /**
     * @return The callback to be invoked with an item in this CarouselAdapter
     *         has been clicked and held, or null id no callback as been set.
     */
    ...
    public void addView(View child, int index) {
        throw new UnsupportedOperationException(
                "addView(View, int) is not supported in CarouselAdapter");
    }
    ...
    public void removeViewAt(int index) {
        throw new UnsupportedOperationException(
                "removeViewAt(int) is not supported in CarouselAdapter");
    }
    ...
    public void removeAllViews() {
        throw new UnsupportedOperationException(
                "removeAllViews() is not supported in CarouselAdapter");
    }
     ...
     *            must be visible in this CarouselAdapter at the time of the
     *            call.
    ...
    /**
     * When the current adapter is empty, the CarouselAdapter can display a
     * special view call the empty view. The empty view is used to provide
     * feedback to the user that no data is available in this CarouselAdapter.
     * 
    ...
    public boolean dispatchPopulateAccessibilityEvent(AccessibilityEvent event) {
        ...
        // current focus/selection. CarouselAdapter fires selection but not
        // focus
