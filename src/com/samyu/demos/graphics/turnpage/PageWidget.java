...
package com.samyu.demos.graphics.turnpage;
...
public class PageWidget extends View {
    ...
    private void calcPoints() {
        ...
        log("mTouchX  " + mTouch.x + "  mTouchY  " + mTouch.y);
        log("mBezierControl1.x  " + mBezierControl1.x
         + "  mBezierControl1.y  " + mBezierControl1.y);
        log("mBezierControl2.x  " + mBezierControl2.x
        ...
        log("mBezierEnd1.x  " + mBezierEnd1.x + "  mBezierEnd1.y  "
         + mBezierEnd1.y);
        log("mBezierEnd2.x  " + mBezierEnd2.x + "  mBezierEnd2.y  "
         + mBezierEnd2.y);
